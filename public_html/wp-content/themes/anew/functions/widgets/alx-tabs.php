...
/* ------------------------------------ */
	function AlxTabs() {
		parent::__construct( false, 'AlxTabs', array('description' => 'Список записей, комментариев, меток, популярного.', 'classname' => 'widget_alx_tabs') );;	
	}
...
/* ------------------------------------ */
	private function _create_tabs($tabs,$count) {
		...
		$titles = array(
			'recent'	=> __('Последние записи','anew'),
			'popular'	=> __('Популярные записи','anew'),
			'comments'	=> __('Последние комментарии','anew'),
			'tags'		=> __('Метки','anew')
		);
		$icons = array(
			...
			<ul id="tab-comments" class="alx-tab group <?php if($instance['comments_avatars']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
						...
						<div class="tab-item-inner group">
							...
							<div class="tab-item-name"><?php echo $comment->comment_author; ?> говорит:</div>
...
?>
	...
	<div class="alx-options-tabs">
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('tabs_category'); ?>">Показать категории</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('tabs_date'); ?>">Показать дату</label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent_enable'); ?>">Включить последние записи</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent_thumbs'); ?>">Показывать миниатюры</label>
		</p>	
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("recent_num"); ?>">Количестро записей</label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("recent_cat_id"); ?>">Категория:</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular_enable'); ?>">Включить популярные записи</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular_thumbs'); ?>">Показывать миниатюры</label>
		</p>	
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("popular_num"); ?>">Количестро записей</label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("popular_cat_id"); ?>">Категория:</label>
		...
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("popular_time"); ?>">Самое комментируемое за:</label>
			<select style="width: 100%;" id="<?php echo $this->get_field_id("popular_time"); ?>" name="<?php echo $this->get_field_name("popular_time"); ?>">
			  <option value="0"<?php selected( $instance["popular_time"], "0" ); ?>>Все время</option>
			  <option value="1 year ago"<?php selected( $instance["popular_time"], "1 year ago" ); ?>>Год</option>
			  <option value="1 month ago"<?php selected( $instance["popular_time"], "1 month ago" ); ?>>Месяц</option>
			  <option value="1 week ago"<?php selected( $instance["popular_time"], "1 week ago" ); ?>>Неделя</option>
			  <option value="1 day ago"<?php selected( $instance["popular_time"], "1 day ago" ); ?>>24 часа</option>
			</select>	
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('comments_enable'); ?>">Включить последние комментарии</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('comments_avatars'); ?>">Показывать аватары</label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("comments_num"); ?>">Количество</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('tags_enable'); ?>">Включить метки</label>
		</p>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_recent"); ?>">Последние записи</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_popular"); ?>">Популярные записи</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_comments"); ?>">Последние комментарии</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_tags"); ?>">Метки</label>
