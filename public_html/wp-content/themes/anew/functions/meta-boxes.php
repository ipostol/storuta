...
$page_options = array(
	...
	'fields'      => array(
		...
		array(
			'label'		=> 'Главный Sidebar',
			'id'		=> '_sidebar_primary',
			'type'		=> 'sidebar-select',
			'desc'		=> 'Выберите нужный виджет'
		),
		array(
			'label'		=> 'Расположение',
			'id'		=> '_layout',
			'type'		=> 'radio-image',
			'desc'		=> 'Расположение колонок по умолчанию',
			'std'		=> 'inherit',
			'choices'	=> array(
				array(
					'value'		=> 'inherit',
...
$post_format_audio = array(
	'id'          => 'format-audio',
	'title'       => 'Format: Audio',
	'desc'        => 'Этот параметр позволяет вставить аудио запись в форматах .mp3 and .ogg/.oga для прослушивания из браузера',
	'pages'       => array( 'post' ),
	'context'     => 'normal',
	'priority'    => 'high',
	'fields'      => array(
